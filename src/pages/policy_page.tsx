    ...
    <main className="mx-auto max-w-3xl px-6 pt-32 pb-24">
      ...
      >
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-6 text-gray-400 leading-relaxed">
          <p>
            At Prometheus SL, we are committed to protecting your privacy. This
          ...
          <p>
            ...
            including account details, usage data, and agent telemetry. We do
          ...
          <p>
            ...
            encryption, JWT-based authentication, and role-based access control
            to protect your information.
          </p>
          <h2 className="text-xl font-semibold text-white">Contact</h2>
          <p>
            If you have questions about this policy, please reach out through
            our GitHub organization at{" "}
            <a
